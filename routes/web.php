...
Route::get('/paket/import_excel', 'PaketController@import_excel');
Route::get('/paket/download_excel/{type}', 'PaketController@download_excel');
Route::post('/paket/import_excel', 'PaketController@import_excel');
