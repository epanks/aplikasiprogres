        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-3">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number"><small>Rp</small>
                        {{-- {{number_format($jmlpaket->sum('pagurmp'))}} --}}
                    </span>
                </div>
                <!-- /.info-box-content -->
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">
                        {{-- {{number_format($jmlpaket->avg('progres_keu'),2)}} --}}
                    </span>
                </div>
                <!-- /.info-box-content -->
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">
                        {{-- {{number_format($jmlpaket->avg('progres_fisik'),2)}} --}}
                    </span>
                </div>
                <!-- /.info-box-content -->
                </div>
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                    <tbody>
                        ...
                        {{-- $total = 0; --}}
                    @foreach ($data_satuan as $paket)  
                    
                        <tr>
                            <td>{{$paket->id}}</td>
                            {{-- <td>{{$paket->kdsatker}}</td> --}}
                            <td>{{$paket->satoutput}}</td>
                            <td>{{$paket->nmsatoutput}}</td>
